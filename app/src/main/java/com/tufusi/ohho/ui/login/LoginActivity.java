...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void login() {
        if (mTencent == null) {
            mTencent = Tencent.createInstance(Constants.APP_KEY, AppGlobal.getsApplication().getApplicationContext());
        }
    ...
    private void getUserInfo(QQToken qqToken, String openid, long expires_time) {
        UserInfo userInfo = new UserInfo(AppGlobal.getsApplication().getApplicationContext(), qqToken);
