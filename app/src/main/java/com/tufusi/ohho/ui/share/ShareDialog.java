package com.tufusi.ohho.ui.share;
...
import com.tufusi.libcommon.view.CornerFrameLayout;
...
public class ShareDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.setViewOutline(ScreenUtils.dip2px(20), ViewHelper.RADIUS_TOP);
        ...
        int margin = ScreenUtils.dip2px(20);
    ...
    private class ShareAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            OHImageView imageView = holder.itemView.findViewById(R.id.share_icon);
